...
const T = {
  ...
  ELSEIF: token("Elseif", "'illaenil'"),
  WHILE: token("While", "'varai'"),
  FOR: token("For", "'mindum'"),
  BREAK: token("Break", "'niruthu'"),
  CONTINUE: token("Continue", "'thodar'"),
  IN: token("In", "'ulla'"),
  AND: token("And", "'matrum'"),
  OR: token("Or", "'allathu'"),
  NOT: token("Not", "'alla'"),
  CONST: token("Const", "'marathu'"),
  // operators
  ASSIGN: token("Assign", "'='"),
